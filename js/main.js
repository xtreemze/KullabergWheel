  ...
  var prefix = (function () {
    ...
    GAMECLASS = (function () {
      ...
      var round = 0,
        ...
        puzzles = ['KULLABERG NATURE RESERVE', 'KULLABERG NATURUM', 'HARBOR PORPOISE', 'PEREGRINE FALCON', 'SWEDEN', 'GATEWAY TO NATURE', 'NATURE IS AROUND THE CORNER', 'GO GREEN THINK TWICE'],
        vowels = ['A', 'E', 'I', 'O', 'U'],
      ...
      return function GAME() {
        ...
        var currentPuzzleArray = [],
          ...
          nextRound = function () {
            ...
            } else Materialize.toast('No more puzzles!', 4000);
          },
